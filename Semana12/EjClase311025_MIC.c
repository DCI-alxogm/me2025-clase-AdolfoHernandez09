/*  Adolfo Hernandez Ramirez
    ...
    Actividad en clase. hacer el código en c del método de Interpolación cuadrática
...
int main() {
    ...
    if (opcion == 1) { // máximo
        ...
        x0 = 0;
        x1 = 1.0;   // valor intermedio arbitrario
        x2 = 2.75;

    } else { // mínimo

        printf("\nEncontraremos el mínimo de la función 2*sin(x)-x*x/10\n");

        x0 = 4;
        x1 = 5;    // valor intermedio arbitrario
        x2 = 6;
    }
